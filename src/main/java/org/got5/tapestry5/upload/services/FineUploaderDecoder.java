...
/**
 * Responsible for detecting and processing file upload requests, using Apache Commons FileUpload. Implementations of this service typically use the threaded
 * service life cycle model.
 */
public interface FineUploaderDecoder {
    ...
    /**
     * Decodes the request, returning a new {@link javax.servlet.http.HttpServletRequest} implementation that will allow access to the form fields submitted in
     * the request (but omits uploaded files).
     *
     * @param request
